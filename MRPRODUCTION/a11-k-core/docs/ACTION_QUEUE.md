...
| A11K-004 | A11-K workflows | n8n wiring | High | blocked | Angel | `N8N_BASE_URL`, `N8N_API_KEY` | Add credentials, then run one safe test | High |
...
No secret values, webhook contents, or customer message bodies belong in this queue.
